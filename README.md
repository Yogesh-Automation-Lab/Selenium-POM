Web Automation: Utilizes Selenium WebDriver to interact with the Erail application, including entering station names and retrieving autocomplete suggestions.
